...
function EmBreve({ titulo }) {
  return (
    <div style={{ background: "#fff", border: "1px solid #e3e0d8", borderRadius: 10, padding: "60px 20px", textAlign: "center" }}>
      <div className="mono" style={{ fontSize: 12, letterSpacing: 1.5, textTransform: "uppercase", color: "#b6936a", marginBottom: 8 }}>Em breve</div>
      <div style={{ fontSize: 20, color: "#5b6470" }}>{titulo}</div>
    </div>
  );
}
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f6f5f1", fontFamily: "'Newsreader', Georgia, serif", color: "#2b2b28" }}>
      ...
      <div style={{ maxWidth: 1040, margin: "0 auto", padding: "32px 24px 80px" }}>
        ...
        {tela === "compras"      && <EmBreve titulo="Compras / Cotação — próxima fase" />}
